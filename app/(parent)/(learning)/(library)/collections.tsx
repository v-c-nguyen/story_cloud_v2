...
export default function CollectionsLibrary() {
  ...
  function handleStoryItem(item: string) {
    ...
    if (
      currentCollection &&
      normalize((currentCollection as any).name) === normalize(item)
    ) {
      setCurrentCollection(null);
    } else if (found) {
      setCurrentCollection(found as any);
    } else {
      setCurrentCollection({ id: item, name: item } as any);
    }
  }
        ...
        <ThemedView style={styles.themedViewContainer}>
          ...
          >
            ...
            <ThemedView style={styles.bottomPadding}>
              <CollectionsListWithBadge
                collectionsCategories={categories}
                loading={loading}
                mode="parent"
              />
            </ThemedView>
